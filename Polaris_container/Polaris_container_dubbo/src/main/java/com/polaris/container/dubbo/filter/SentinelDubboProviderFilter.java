...
import com.polaris.container.dubbo.config.SentinelDubboConfig;
import com.polaris.container.dubbo.fallback.DubboFallbackRegistry;
...
public class SentinelDubboProviderFilter extends AbstractDubboFilter implements Filter {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        try {
            String resourceName = getResourceName(invoker, invocation, SentinelDubboConfig.getDubboProviderPrefix());
