...
public class EhCacheFactory {
    ...
    public static net.sf.ehcache.Cache getEhCache() {
    	return getEhCache(com.polaris.cache.Cache.CACHE_DEFAULT_NAME);
    }
    public static net.sf.ehcache.Cache getEhCache(String cacheName) {
		int maxSize = Integer.parseInt(ConfClient.get("cache."+cacheName+".maxsize", com.polaris.cache.Cache.CACHE_MAX_SIZE_DEFAULT_VALUE));
