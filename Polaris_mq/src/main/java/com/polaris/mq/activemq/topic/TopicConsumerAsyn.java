...
public class TopicConsumerAsyn extends TopicConsumerBase implements MessageListener{

	private static final LogUtil logger = LogUtil.getInstance(TopicConsumerAsyn.class);
