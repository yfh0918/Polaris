...
public final class VersionUpdate {
	public static void main(String[] args) throws Exception { 
		String oldChar = "<version>1.2.0</version>";
		String newChar = "<version>1.2.1</version>";
		String oldChar2 = "<polaris-version>1.2.0</polaris-version>";
		String newChar2 = "<polaris-version>1.2.1</polaris-version>";
