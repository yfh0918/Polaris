...
public final class VersionUpdate {
	public static void main(String[] args) throws Exception { 
		String oldChar = "<version>1.6.2</version>";
		String newChar = "<version>1.7.0</version>";
		String oldChar2 = "<polaris-version>1.6.2</polaris-version>";
		String newChar2 = "<polaris-version>1.7.0</polaris-version>";
