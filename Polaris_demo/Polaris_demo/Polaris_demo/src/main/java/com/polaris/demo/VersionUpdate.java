...
public final class VersionUpdate {
	public static void main(String[] args) throws Exception { 
		String oldChar = "<version>1.5.6</version>";
		String newChar = "<version>1.6.0</version>";
		String oldChar2 = "<polaris-version>1.5.6</polaris-version>";
		String newChar2 = "<polaris-version>1.6.0</polaris-version>";
