...
public final class VersionUpdate {
	public static void main(String[] args) throws Exception { 
		String oldChar = "<version>1.1.4</version>";
		String newChar = "<version>1.1.5</version>";
		String oldChar2 = "<polaris-version>1.1.4</polaris-version>";
		String newChar2 = "<polaris-version>1.1.5</polaris-version>";
