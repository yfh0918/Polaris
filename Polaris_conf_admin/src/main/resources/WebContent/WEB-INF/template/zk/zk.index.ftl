					...
					<div class="box">
			            ...
			            <div class="box-body">
			              	<table id="joblog_list" class="table table-bordered table-striped display" width="100%" >
				                <thead>
					            	<tr>
                                        <th name="zkName" >ZK名称</th>
                                        <th name="zkValue" >ZK值</th>
					                </tr>
				                </thead>
                                <tbody>
								...
								<#list list as zk>
									<tr>
                                        ...
                                        <td>${zk.zkValue}</td>
										<td>
                                            <button class="btn btn-warning btn-xs update" zkName="${zk.zkName}" zkValue="${zk.zkValue}" >编辑</button>
                                            <button class="btn btn-danger btn-xs remove" zkName="${zk.zkName}" >删除</button>
										</td>
									</tr>
								</#list>
								</#if>
