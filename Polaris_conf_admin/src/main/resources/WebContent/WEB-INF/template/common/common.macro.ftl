...
<#macro commonScript>
	...
	<script src="${request.contextPath}/static/js/alert.1.js"></script>
...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>Conf</b></span>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
                ...
                <li class="nav-click" ><a href="${request.contextPath}/zk"><i class="fa fa-circle-o text-red"></i> <span>ZK管理</span></a></li>
			</ul>
		</section>
		<!-- /.sidebar -->
	</aside>
